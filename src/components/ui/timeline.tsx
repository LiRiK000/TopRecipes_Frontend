...
export const Timeline = ({ data }: { data: TimelineEntry[] }) => {
  ...
  return (
    <div
      ...
      ref={containerRef}
    >
      <div className="mx-auto max-w-7xl px-4 py-4 md:px-8 lg:px-10">
        <h2 className="mb-4 max-w-4xl text-lg text-black dark:text-white md:text-4xl">
          TopRecipes service path
        </h2>
        <p className="max-w-sm text-sm text-neutral-700 dark:text-neutral-300 md:text-base">
          We have been working for a long time to provide you with the
          TopRecipes service, on this service you can create and manage your
          recipes, share them, rate other recipes and much more.
        </p>
      </div>
